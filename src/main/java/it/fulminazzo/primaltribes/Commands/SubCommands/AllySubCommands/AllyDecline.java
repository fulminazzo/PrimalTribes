...
public class AllyDecline extends ListClanSubCommand {

    public AllyDecline(AbstractCommand command, String commandName) {
        super(command, "decline", Permissions.ALLY_DECLINE, ClanPermission.ALLY_DECLINE,
                StringUtils.getCommandSyntax(String.format("&c%s &adecline", commandName), "clan"),
                Message.HELP_ALLY_DECLINE.getMessage(false, false),
    ...
    public void execute(CommandSender sender, Command cmd, String[] args) {
        checkClan(sender);
        execute(sender, args, Message.NO_CLAN_TO_ALLY_DECLINE,
                ...
                clanName -> {
                    ...
                    if (c == null)
                        ...
                        clan.declineAllyRequest(c);
                        sender.sendMessage(Message.CLAN_ALLY_DECLINED.getMessage(!isAdminCommand(), isAdminCommand())
                                .replace("%clan%", c.getDisplayName()));
                    }
                });
    }
